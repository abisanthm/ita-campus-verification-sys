    ...
    <div class="card">
            ...
            <div class="card-body">
                <form action="{{ isset($role) ? route('roles.update', $role->id) : route('roles.store') }}" method="post">
                    ...
                    @endif
                    <div class="mb-3 row">
                        <label for="name" class="col-md-4 col-form-label text-start">Role Name</label>
                        <div class="col-md-6">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6" style="margin-left:20px">
                            @php
                            $categories = ['Value', 'Role', 'Mail', 'Setting', 'Student', 'User','Program','Program Type','Certificate Setting','User Logs'];
                            @endphp

                            <table>
                                @foreach ($categories as $category)
                                    <tr>
                                        <th colspan="2" style="padding-bottom: 10px;padding-top:10px">{{ $category }}</th>
                                    </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check" style="margin-left: 15px">
                                                        ...
                                                        <label style="margin-left:8px;" class="form-check-label" for="{{ $permission['name'] }}">{{ $permission['display_name'] }}</label>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endif
